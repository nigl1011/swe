...
public class Warenkorb implements Serializable {
	private static final long serialVersionUID = -2673483769027778841L;
	...
	private List<Bestellposten> positionen;
	...
	public String add(Artikel artikel) {
		...
		final Bestellposten neu = new Bestellposten(artikel);
		positionen.add(neu);
		return JSF_VIEW_WARENKORB;
	}
	 ...
	 */
	@Log
	public void remove(Bestellposten bestellposition) {
